...
# Specific
v_data <- c("D:/Learning epi-master/Research Project/Code/Code and Result 2025/Result_500_new/seed0620 TO5 PT5IO0.5_S.RData",# random seed 0620, the treatment effect is 5 (RR=5)
            ...
            "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Result_500_new/seed0620 TO1.5 PT5IO0.5_S.RData",# random seed 0620, the treatment effect is 1.5 (RR=1.5)
            ...
            "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Result_500_new/seed1217 TO5 PT5IO0.5_S.RData",# random seed 1217, the treatment effect is 5 (RR=5)
            ...
            "D:/Learning epi-master/Research Project/Code/Code and Result 2025/Result_500_new/seed1217 TO1.5 PT5IO0.5_S.RData",# random seed 1217, the treatment effect is 1.5 (RR=1.5)
...
# loop for 4 different settings
for (i_bias in 1:4) {
  # load the data, and make the data form 
  load(v_data[9*i_bias-8])
  perc25 <- sapply(1:20, function(x)Result_form[[x]][7,2])
  perc10 <-  sapply(1:20, function(x)Result_form[[x]][8,2])
  gen <-  sapply(1:20, function(x)Result_form[[x]][9,2])
  ...
  # data for the 25% model vs the generic model
  df_25vsgen <- df_25vs10vsgen %>%
    filter(model %in% c("perc25", "gen"))
  # data for the 10% model vs the generic model
  df_10vsgen <- df_25vs10vsgen %>%
    filter(model %in% c("perc10", "gen"))
  
  # data for the 25% model vs the generic model, when the IO is high
  df_25vsgen_IO5IO10 <- df_25vsgen %>%
    filter(PTIO %in% c("PT5IO5","PT5IO10",
                       "PT20IO5","PT20IO10",
                       "PT50IO5","PT50IO10"))
  # data for the 10% model vs the generic model, when the IO is high
  ...
  p1 <- ggplot(df_25vsgen, aes(x = PTIO, y = value, fill = model)) +
    ...
    scale_y_continuous(limits = c(0, 0.3), breaks = seq(0, 0.3, by = 0.06)) +
    scale_x_discrete(expand = expansion(mult = c(0.1, 0.1))) +
    labs(x = "Scenarios", y = "Absolute Bias", title = "The 25% model vs Generic model in Absolute Bias in Different Scenarios") +
    theme_minimal() +
    theme(
  ...
  p2 <- ggplot(df_10vsgen, aes(x = PTIO, y = value, fill = model)) +
    ...
    scale_x_discrete(expand = expansion(mult = c(0.1, 0.1))) +
    labs(x = "Scenarios", y = "Absolute Bias", title = "The 10% model vs Generic model in Absolute Bias in Different Scenarios") +
    theme_minimal() +
    theme(
      panel.background = element_rect(fill = "white", color = "black"), 
      plot.background = element_rect(fill = "white"),  
  ...
  for (j_bias in 1:3) {
    df__changingPT <-  data.frame(rbind(df_list[[j_bias]],df_list[[j_bias+3]],df_list[[j_bias+2*3]]))
    ...
    boxplot_changingPT_per25 <- ggplot(data = df__changingPT_25,aes(x = PT,y = value))+
      ...
      labs(x = "Prevalence of Treatment", y = "Absolute Bias", title = paste("The Absolute Bias of the 25% Model: Changing Prevalence of Treatment when",IO_name[j_bias])) +
      theme_minimal() +
      theme(
        panel.background = element_rect(fill = "white", color = "black"), 
        plot.background = element_rect(fill = "white"),  
    ...
    boxplot_changingPT_per10 <- ggplot(data = df__changingPT_10,aes(x = PT,y = value))+
      geom_boxplot(width = 0.4,position = position_dodge(width = 1), alpha = 0.6,outlier.size = 2,outlier.alpha = 0.5,size = 1)+
      labs(x = "Prevalence of Treatment", y = "Absolute Bias", title = paste("The Absolute Bias of the 10% Model: Changing Prevalence of Treatment when",IO_name[j_bias])) +
      theme_minimal() +
      theme(
        panel.background = element_rect(fill = "white", color = "black"), 
        plot.background = element_rect(fill = "white"),  
    ...
    boxplot_changingPT_gen <- ggplot(data = df__changingPT_gen,aes(x = PT,y = value))+
      geom_boxplot(width = 0.4,position = position_dodge(width = 1), alpha = 0.6,outlier.size = 2,outlier.alpha = 0.5,size = 1)+
      labs(x = "Prevalence of Treatment", y = "Absolute Bias", title = paste("The Absolute Bias of the Generic Model: Changing Prevalence of Treatment when",IO_name[j_bias])) +
      theme_minimal() +
      theme(
        panel.background = element_rect(fill = "white", color = "black"), 
        plot.background = element_rect(fill = "white"),  
    ...
    changingPT_plot_list[[j_bias]][[1]] <- boxplot_changingPT_per25
    changingPT_plot_list[[j_bias]][[2]] <- boxplot_changingPT_per10
    changingPT_plot_list[[j_bias]][[3]] <- boxplot_changingPT_gen
  }
  plot_list2[[i_bias]] <- changingPT_plot_list
}
...
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot/without un/Bias/S/25vsgen_0620.png",plot = p_com_25vsgen_0620,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot/without un/Bias/S/25vsgen_1217.png",plot = p_com_25vsgen_1217,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot/without un/Bias/S/10vsgen_0620.png",plot = p_com_10vsgen_0620,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot/without un/Bias/S/10vsgen_1217.png",plot = p_com_10vsgen_1217,width = 24,height = 12,dpi = 330)
...
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/S/per25_0620.png",plot = p_com_25_0620,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/S/per10_0620.png",plot = p_com_10_0620,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/S/gen_0620.png",plot = p_com_gen_0620,width = 24,height = 12,dpi = 330)

ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/S/per25_1217.png",plot = p_com_25_1217,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/S/per10_1217.png",plot = p_com_10_1217,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/S/gen_1217.png",plot = p_com_gen_1217,width = 24,height = 12,dpi = 330)
...
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot/without un/Bias/SC/25vsgen_0620.png",plot = p_com_25vsgen_0620,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot/without un/Bias/SC/25vsgen_1217.png",plot = p_com_25vsgen_1217,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot/without un/Bias/SC/10vsgen_0620.png",plot = p_com_10vsgen_0620,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot/without un/Bias/SC/10vsgen_1217.png",plot = p_com_10vsgen_1217,width = 24,height = 12,dpi = 330)
...
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/SC/per25_0620.png",plot = p_com_25_0620,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/SC/per10_0620.png",plot = p_com_10_0620,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/SC/gen_0620.png",plot = p_com_gen_0620,width = 24,height = 12,dpi = 330)

ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/SC/per25_1217.png",plot = p_com_25_1217,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/SC/per10_1217.png",plot = p_com_10_1217,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/SC/gen_1217.png",plot = p_com_gen_1217,width = 24,height = 12,dpi = 330)
...
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot/without un/Bias/C/25vsgen_0620.png",plot = p_com_25vsgen_0620,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot/without un/Bias/C/25vsgen_1217.png",plot = p_com_25vsgen_1217,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot/without un/Bias/C/10vsgen_0620.png",plot = p_com_10vsgen_0620,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot/without un/Bias/C/10vsgen_1217.png",plot = p_com_10vsgen_1217,width = 24,height = 12,dpi = 330)
...
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/C/per25_0620.png",plot = p_com_25_0620,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/C/per10_0620.png",plot = p_com_10_0620,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/C/gen_0620.png",plot = p_com_gen_0620,width = 24,height = 12,dpi = 330)

ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/C/per25_1217.png",plot = p_com_25_1217,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/C/per10_1217.png",plot = p_com_10_1217,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/C/gen_1217.png",plot = p_com_gen_1217,width = 24,height = 12,dpi = 330)
...
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot/without un/Bias/US/25vsgen_0620.png",plot = p_com_25vsgen_0620,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot/without un/Bias/US/25vsgen_1217.png",plot = p_com_25vsgen_1217,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot/without un/Bias/US/10vsgen_0620.png",plot = p_com_10vsgen_0620,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot/without un/Bias/US/10vsgen_1217.png",plot = p_com_10vsgen_1217,width = 24,height = 12,dpi = 330)
...
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/US/per25_0620.png",plot = p_com_25_0620,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/US/per10_0620.png",plot = p_com_10_0620,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/US/gen_0620.png",plot = p_com_gen_0620,width = 24,height = 12,dpi = 330)

ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/US/per25_1217.png",plot = p_com_25_1217,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/US/per10_1217.png",plot = p_com_10_1217,width = 24,height = 12,dpi = 330)
ggsave(filename = "D:/Learning epi-master/Research Project/Final_2025_Doc/Final Plot/Boxplot_changing_PT/without un/Bias/US/gen_1217.png",plot = p_com_gen_1217,width = 24,height = 12,dpi = 330)
